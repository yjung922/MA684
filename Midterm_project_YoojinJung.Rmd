...
lm.dt7.2: The intercepts are in general smaller than those in lm.dt7.1, but the slopes for exercise and drink are greater, therefore increasing the variability of the predictions. The variance of the randon effect for education is 0.038, indicating the group level variance is relatively minor compared to the individual level variance.
